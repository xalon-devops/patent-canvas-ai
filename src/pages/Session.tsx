...
const Session = () => {
  ...
  const handleSendMessage = async () => {
    ...
    try {
      if (chatPhase === 'initial') {
        ...
        // Simulate AI questions (in a real app, this would call an AI service)
        const aiQuestions = [
          "What specific problem does your invention solve?",
          "How is your invention different from existing solutions?",
          "What are the key technical features of your invention?",
          "Who would be the primary users of your invention?",
          "Are there any specific industries or applications for your invention?"
        ];
        ...
        if (currentQuestion) {
          ...
          if (answeredCount >= 3) {
            ...
            const remainingQuestions = [
              "What materials or technologies does your invention use?",
              "Have you seen anything similar to your invention before?",
              "What advantages does your invention offer over existing solutions?"
            ];
            
            const nextQuestion = remainingQuestions[answeredCount - 1];
            if (nextQuestion) {
              const { error: questionError } = await supabase
                .from('ai_questions')
                .insert([{
  ...
  const performPriorArtSearch = async () => {
    ...
    try {
      // Simulate prior art search results (in a real app, this would call a patent search API)
      const mockResults = [
        {
          title: "Smart Device Management System",
          publication_number: "US10123456B2",
          summary: "A system for managing multiple smart devices through a centralized interface...",
          similarity_score: 0.85,
          url: "https://patents.google.com/patent/US10123456B2"
        },
        {
          title: "Automated Home Control Method",
          publication_number: "US9876543A1", 
          summary: "Methods and systems for automatically controlling home appliances based on user preferences...",
          similarity_score: 0.72,
          url: "https://patents.google.com/patent/US9876543A1"
        },
        {
          title: "IoT Device Communication Protocol",
          publication_number: "US11234567B1",
          summary: "A communication protocol for Internet of Things devices to exchange data efficiently...",
